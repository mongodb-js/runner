// Shim for fixing node pretest -> electron-rebuild test -> node posttest
// node: symbol lookup error: build/Release/kerberos.node: undefined symbol:
var optional = require('require_optional');
optional.exists = function() {
  return false;
};
